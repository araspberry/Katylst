...
export default function PhoneMockup() {
  const doubled = [...LEADS, ...LEADS] // duplicate for seamless loop
  ...
  return (
    <div className="relative h-[660px] flex items-center justify-center">
      ...
      {/* iPhone */}
      <div className="relative z-[5] w-[320px] h-[580px] bg-k-bg rounded-phone border-[3px] border-[rgba(26,26,26,0.9)] overflow-hidden flex flex-col shadow-[0_25px_70px_rgba(0,0,0,0.22),_0_8px_24px_rgba(0,0,0,0.12)]">
